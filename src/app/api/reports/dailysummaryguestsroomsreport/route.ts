...
export async function GET(request: NextRequest) {
  try {
    ...
    const result = await reportService.getDailySummaryGuestsRoomsReport(searchParams.startDate, searchParams.endDate, searchParams.reservationStatus ?? '', session.user);
