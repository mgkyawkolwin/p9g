...
export async function GET(request: NextRequest) {
  try {
    c.fs("GET /api/reports/dailysummaryzoneguestsreport");
    ...
    const result = await reportService.getDailySummaryZoneGuestsReport(searchParams.startDate, searchParams.endDate, searchParams.reservationStatus ?? '', session.user);
