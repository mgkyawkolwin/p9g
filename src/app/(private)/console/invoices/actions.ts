...
export async function invoiceGetById(id: string): Promise<FormState> {
  try {
...
export async function invoiceUpdate(id: string, invoice: Invoice): Promise<FormState> {
  try {
...
export async function invoiceCreate(invoice: Invoice): Promise<FormState> {
  try {
