...
export async function billDelete(reservationId: string, billId: string, location: string): Promise<FormState> {
  try {
...
export async function billsGet(id: string, location: string): Promise<FormState> {
  try {
...
export async function billsSave(id: string, bills: Bill[], location: string): Promise<FormState> {
  try {
...
export async function getReservation(reservationId:string, location: string){
...
export async function reservationPatch(reservationId: string, patchData: any, location: string): Promise<FormState> {
  try {
...
export async function invoiceView(id: string, location: string): Promise<FormState> {
  try {
...
export async function paymentsGet(id: string, location: string): Promise<FormState> {
  try {
...
export async function paymentsDelete(reservationId: string, paymentId: string, location: string): Promise<FormState> {
  try {
...
export async function paymentsSave(id: string, payments: Payment[], location: string): Promise<FormState> {
  try {
...
export async function paymentsView(id: string, location: string): Promise<FormState> {
  try {
...
export async function roomChargeGetListById(id: string, location: string): Promise<FormState> {
  try {
...
export async function roomChargeUpdateList(id: string, roomCharges: RoomCharge[], location: string): Promise<FormState> {
  try {
...
export async function roomReservationGetListById(id: string, location: string): Promise<FormState> {
  try {
...
export async function roomReservationUpdateList(id: string, roomReservations: RoomReservation[], location: string): Promise<FormState> {
  try {
...
export async function reservationCancel(id: string, location: string): Promise<FormState> {
  try {
