...
export async function getTopReservationsAction(location: string): Promise<FormState> {
  try{
...
export async function searchCustomer(search:string, location: string){
...
export async function updateReservationAction(reservation: Reservation, location: string): Promise<FormState> {
  try{
