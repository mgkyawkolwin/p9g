...
export async function generateTimeTable(date:Date, start:Date, end:Date, location: string): Promise<FormState> {
  try{
...
export async function getTimeTable(date:Date, location: string): Promise<FormState> {
  try{
...
export async function getRoomNames(drawDate: Date, location: string): Promise<FormState> {
  try{
...
export async function updateTimeTable(timeTable:PookieTimeTable, location: string): Promise<FormState> {
  try{
...
export async function getNoDraw(drawDate: Date, location: string): Promise<FormState> {
  try{
