...
export default interface IReservationService {
    ...
    reservationGetList(searchParams:SearchParam[], pagerParams:PagerParams, list:string, sessionUser: SessionUser): Promise<[Reservation[], number]>;
    ...
    roomReservationGetList(searchParam:SearchParam[], sessionUser: SessionUser) : Promise<[Room[], number]>;
    ...
    roomScheduleGetList(searchParam:SearchParam[], sessionUser: SessionUser) : Promise<[Room[], number]>;
