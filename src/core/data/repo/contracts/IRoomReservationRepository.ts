...
// export default interface IRoomReservationRepositoryX extends IRepository<RoomReservation>{
...
//     getLatestByReservationId(reservationId: string) : Promise<RoomReservation>;
// }