...
CREATE TABLE `reservation` (
	...
	`roomNo` varchar(10),
	`isPickUpRequired` boolean NOT NULL DEFAULT true,
	`isPickUpSharedRide` boolean NOT NULL DEFAULT true,
	`pickUpFee` tinyint,
	`pickUpCurrency` char(3),
	`pickUpCarNo` varchar(10),
	`isDropOffRequired` boolean NOT NULL DEFAULT true,
	`isDropOffSharedRide` boolean NOT NULL DEFAULT true,
	`dropOffFee` tinyint,
